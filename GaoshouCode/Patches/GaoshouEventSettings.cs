...
public sealed class GaoshouEventSettings : SingletonModel
{
    ...
    [
        ("smite_master", "打击大师", "Smite Master",
            "第一层/第二层：教打击的老前辈。", "Act 1/2: an old master who teaches Strikes."),
        ("guard_master", "格挡达人", "Guard Master",
            "第二层/第三层：练格挡的大哥。", "Act 2/3: a guy who trains blocks."),
        ("roadside_bench", "路边的工作台", "Roadside Workbench",
            "第一层：给一张牌附魔。", "Act 1: enchant a card."),
        ("odd_jobs", "万事屋", "Odd Jobs Shop",
            "第一层：花金币升级牌、打工赚钱或休息回血。", "Act 1: spend gold to upgrade, work for gold, or rest."),
        ("magic_prodigy", "魔法鬼才", "Magic Prodigy",
            "从2张意义不明的魔法卡中选择1张，或者变得神秘。",
            "Pick 1 of 2 cryptic magic cards — or become mysterious."),
        ("grand_library", "大书库", "Grand Library",
            "第二层/第三层：借书（选牌入组）或捐赠（删牌换遗物）。", "Act 2/3: borrow cards, or donate one for a relic."),
        ("super_upgrader", "超级强化机", "Super Upgrader",
            "第三层：花金币或生命抽概率升级牌。", "Act 3: gamble gold or HP to upgrade cards."),
        ("mysterious_cave", "神秘洞穴", "Mysterious Cave",
            "密林：层层深入的洞窟。", "The Overgrowth: a cave that goes deeper."),
        ("mysterious_shop", "神秘商店", "Mysterious Shop",
            "一个只卖顶级物品的神秘摊贩。", "A mysterious vendor who only sells top-tier goods."),
        ("strange_temple", "奇怪神殿", "Strange Temple",
            "里面有一座奇怪的雕像，还有很多散落的财宝。",
            "Inside: a strange statue, and treasure scattered all around."),
    ];
